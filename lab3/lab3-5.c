...
void init(void)
{
  ...
  myLookAt.x = -1;
	...
	LoadTGATextureSimple("conc.tga", &tex3);
...
void windmill(GLfloat x, GLfloat y, GLfloat z, GLfloat ro, GLfloat randNum)
{
...
void display(void)
{
  ...
  mat4 cameraMatrix;
	...
	//texture
	glUniform1f(glGetUniformLocation(program, "mixAlpha"), cos(t / 10));
  ...
  DrawModel(m8, program, "in_Position", "in_Normal", "inTexCoord");
	...
	windmill(0, 10, 0, 0, ((GLfloat)(rand1 % 4) - 8) / 3);
	windmill(0, 0, 20, -0.1, ((GLfloat)(rand2 % 4) - 8) / 3);
	windmill(0, 0, -20, 1.58f, ((GLfloat)(rand3 % 4) - 8) / 3);
	windmill(20, 0, 0, 0.6, ((GLfloat)(rand1 % 4) - 8) / 3);
	windmill(-20, 0, 20, 0.7, ((GLfloat)(rand2 % 4) - 8) / 3);
	windmill(40, 0, -20, 3.14f, ((GLfloat)(rand3 % 4) - 8) / 3);
